...
void ASVSIFT_Impl::buildDoGPyramid( const std::vector<Mat>& gpyr, std::vector<Mat>& dogpyr ) const
{
...
int ASVSIFT_Impl::descriptorSize() const
{
    return SIFT_DESCR_WIDTH*SIFT_DESCR_WIDTH*SIFT_DESCR_HIST_BINS;
}

int ASVSIFT_Impl::descriptorType() const
{
    return CV_32F;
}

int ASVSIFT_Impl::defaultNorm() const
{
    return NORM_L2;
}
